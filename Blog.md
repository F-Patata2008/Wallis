...
**Enunciado final:**
_Wallis es un robot autónomo tipo tractor, diseñado para la limpieza de macroplásticos y residuos enterrados en playas, con operación nocturna y capacidad de acción subsuperficial._
...
Durante esta jornada se completó la migración del blog al archivo `Blog.md`. El cambio se realizó mediante la creación de una rama en Git, seguida de su respectivo _pull request_, el cual fue revisado por Felipe Colli e integrado posteriormente al proyecto.
...
## 14/08 — Inicio del proyecto

Durante la primera sesión del semestre, el equipo realizó una reflexión sobre sus capacidades, intereses y áreas de aprendizaje. El objetivo fue reconocer cómo cada integrante puede aportar al trabajo grupal y definir qué problemática queremos seguir explorando durante esta etapa.

### Reflexión del equipo

| Integrante | ¿Qué sabemos hacer?                                                                                               | ¿Qué disfrutamos hacer?                                                              | ¿Qué queremos aprender?                                                               | ¿Qué problemas nos interesan?                                                                      |
| ---------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| Felipe     | Coordinar al equipo, gestionar el blog y utilizar herramientas de inteligencia artificial para apoyar el trabajo. | Participar en clases, conversar con el equipo y organizar el contenido del proyecto. | Mejorar el uso responsable de herramientas digitales e IA para desarrollar proyectos. | La contaminación de las playas y la protección del entorno natural.                                |
| Joaquín    | Modelar en 3D y aportar al desarrollo visual de las propuestas.                                                   | Generar vínculos con el equipo y colaborar durante el proceso de trabajo.            | Fortalecer el modelado 3D, aprender sobre circuitos, soldadura y prototipado.         | La programación y la electrónica aplicadas a proyectos de ingeniería.                              |
| Benjamín   | Investigar, imaginar alternativas y diseñar posibles soluciones.                                                  | Analizar problemas y proponer ideas para resolverlos.                                | Aprender más sobre electrónica y robótica.                                            | Las dificultades técnicas que presenta el desplazamiento y funcionamiento de sistemas sobre arena. |
| Diego      | Investigar y aplicar conocimientos básicos de programación.                                                       | Aprender, desarrollar proyectos y aportar a la comunidad.                            | Comprender cómo estructurar y ejecutar un proyecto de carácter profesional.           | La contaminación de los ecosistemas y sus impactos en las comunidades.                             |
| Agustín    | Crear, presentar proyectos y respaldarlos mediante investigación y evidencia.                                     | Construir prototipos tangibles y transformar ideas en objetos o sistemas concretos.  | Diseñar soluciones de ingeniería que contribuyan a mejorar la calidad de vida.        | La contaminación de los ecosistemas y las formas de enfrentarla mediante ingeniería.               |

### Problemática de interés

Como equipo, nos interesa profundizar en la contaminación de las playas chilenas, especialmente en la acumulación de residuos pequeños como colillas de cigarro, plásticos, tapas y fragmentos de vidrio. Este problema afecta el paisaje, la experiencia de quienes visitan las playas y la seguridad de las personas, particularmente de niños y niñas que juegan o caminan descalzos sobre la arena.

La problemática también tiene consecuencias ambientales. Los residuos abandonados en la costa pueden permanecer por largos períodos, ser arrastrados hacia el mar y afectar a la fauna y a los ecosistemas costeros. En Chile, las jornadas de limpieza de playas han identificado de forma recurrente la presencia de plásticos y colillas entre los residuos más recogidos. En 2023, las actividades de limpieza movilizaron a 10.131 voluntarios en 91 playas y recolectaron 98.176 kg de residuos.[128]

La situación sigue siendo relevante: en una jornada nacional realizada en 2025 participaron 9.288 voluntarios, se limpiaron 107 playas y se retiraron 72 toneladas de desechos.[131] Además, una estrategia del Ministerio del Medio Ambiente indica que, en un muestreo de 32 playas realizado en 2020, los residuos más abundantes fueron plásticos (34,6%), vidrios (22,4%) y colillas de cigarrillos (20%).[138]

### Problemática definida

A partir de la reflexión grupal y la investigación inicial, definimos la siguiente problemática:

> En las playas chilenas, la acumulación de residuos pequeños —como colillas de cigarro, plásticos y fragmentos de vidrio— deteriora el entorno costero, afecta la experiencia de los visitantes y puede representar un riesgo para las personas y la fauna.

Esta problemática se relaciona con el Objetivo de Desarrollo Sostenible 14, que busca prevenir y reducir significativamente la contaminación marina, especialmente aquella originada por actividades realizadas en tierra.[130]
...
### Actividad 2.1 — Matriz aplicada del problema

La matriz se estructura a partir de la fórmula trabajada en clase:

**Usuario y contexto + Necesidad + Evidencias + Síntomas + Hallazgos e insights**
